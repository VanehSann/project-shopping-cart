...
<p align="center"><b>
 ...
 <a href="#---shopping-cart-project-------">README em Português 🇧🇷</a>
  </b>
</p>
<h1 align="center">
...
<table>
    <tr>
      <td><br>
        <p align="left">
      Nesse projeto é feito requisições a uma API (Application Programming Interface) do Mercado Livre,
      trabalhado com funções assíncronas, é criado testes unitários e utilizado JavaScript, CSS e HTML..
      Com tudo isso é simulado uma loja virtual, com carrinho de compras com soma dos preços dos produtos,
      com webStorage para salvar as compras e qualquer alteração no carrinho, como deletar item, adicionar mais item.
      Foi o último projeto de Fundamentos 
      para fixar mais uma vez, conteúdos do módulo, em um só projeto.</p>
      </td>
    </tr>
    <tr>
      <td><br>
